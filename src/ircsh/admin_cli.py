...
def build_parser():
 ...
 q=ap.add_parser("set-plan");q.add_argument("username");q.add_argument("plan")\n r=ap.add_parser("reconcile");r.add_argument("username");r.add_argument("--exists",action="store_true");r.add_argument("--apply",action="store_true");return p
def execute(argv,store=None,runner=None,audit=None):
